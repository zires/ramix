...
You will find all options supported.
    ...
    Authentication options:
      ...
      -A, [--omniauth]   # OmniAuth is a flexible authentication system utilizing Rack middleware.
    ...
    Front-end options:
      -F, [--front=FRONT]  # Preconfigure for selected front-end template or plugin(options: bootstrap/h5bp/).\
                             Note that h5bp refer to html5-boilerplate.
                           # Default: bootstrap
